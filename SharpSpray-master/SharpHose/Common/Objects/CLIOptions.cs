...
namespace SharpHose.Common.Objects
{
    public class CLIOptions
    {
        ...
        [Option("auto", Default = false,
            HelpText = "Automatically start spraying without password list.")]
        ...
        [Option("passfile", Required = false,
            HelpText = "The file path of password")]
